...
TEST_GROUP(qspi_flash_fast_read_valid_div3);

TEST_SETUP(qspi_flash_fast_read_valid_div3)
{
...
TEST_TEAR_DOWN(qspi_flash_fast_read_valid_div3)
{
    qspi_flash_fast_read_shutdown(ctx);
}

__attribute__((fptrgroup("unity_test_func")))
TEST(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read)
{
...
__attribute__((fptrgroup("unity_test_func")))
TEST(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read_data)
{
    uint8_t buf[255];
...
__attribute__((fptrgroup("unity_test_func")))
TEST(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read_data2)
{
    uint8_t buf[255];
...
__attribute__((fptrgroup("unity_test_func")))
TEST(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read_data_random_small)
{
    uint8_t buf;
    qspi_flash_fast_read_mode_set(ctx, qspi_fast_flash_read_transfer_raw);
...
__attribute__((fptrgroup("unity_test_func")))
TEST(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read_data_random_mixed)
{
    uint8_t buf[255];
    qspi_flash_fast_read_mode_set(ctx, qspi_fast_flash_read_transfer_raw);
...
__attribute__((fptrgroup("unity_test_func")))
TEST(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read_erased)
{
    uint8_t buf[255];
...
TEST_GROUP_RUNNER(qspi_flash_fast_read_valid_div3) {
    RUN_TEST_CASE(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read);
    RUN_TEST_CASE(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read_data);
    RUN_TEST_CASE(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read_data2);
    RUN_TEST_CASE(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read_data_random_small);
    RUN_TEST_CASE(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read_data_random_mixed);
    RUN_TEST_CASE(qspi_flash_fast_read_valid_div3, test_qspi_flash_fast_read_erased);
}
